...
| [ParVuEx](https://github.com/BradXiao/ParVuEx) | `[Beginner - Intermediate]` | Enhanced Parquet/CSV viewer with SQL query execution using DuckDB, featuring syntax highlighting and data statistics |
